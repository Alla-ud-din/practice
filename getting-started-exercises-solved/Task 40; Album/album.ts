/*Q. Write a function called make_album() that builds a Object describing a music album. 
...
function make_album(name: string, title: string, tracks?: undefined | number){
    let music_album = {
        artistName: name,
        albumTitle: title,
...
console.log(make_album("Dhinchak Pooja", "Selfie Maine Leli Aaj"));
console.log(make_album("Rahat fateh Ali Khan", "Back 2 Love", 10));
console.log(make_album("Chahat fateh Ali khan", "Ye Jo Pyaara PSL Hai"));

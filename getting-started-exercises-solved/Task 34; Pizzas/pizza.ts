/*Q.Think of at least three kinds of your favorite pizza. 
...
let pizza =['Margherita', 'Pepperoni', 'BBQ'];
for (let i=0; i<pizza.length; i++){
    console.log(`I like ${pizza[i]}`)
}
console.log(`I really love pizza! Its versatility and ability
to cater to a variety of tastes and preferences make it an 
all-time favorite comfort food for me. 
The endless possibilities of toppings and crust styles 
ensure there's always something exciting to try and savor.`)